...
//}
//
//desktopWeightsAutoWritePath =  "Desktop/ReversiChallengeData1/" + "gameSize:\(gameSize)"+isPlayerWhiteString+withAbilityString+difficultyString+"????????????.txt"
